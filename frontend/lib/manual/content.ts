    ...
    processes: [
      {
        ...
        steps: {
          es: [
            ...
            'Verifica desde /admin-panel/analytics que las impresiones empiezan a contar.',
          ],
          en: [
            ...
            'Check /admin-panel/analytics to confirm impressions start counting.',
          ],
        },
    ...
    processes: [
      {
        ...
        summary: {
          es: 'Qué muestra /admin-panel/analytics.',
          en: 'What /admin-panel/analytics shows.',
        },
        why: {
