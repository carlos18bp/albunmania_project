...
class Command(BaseCommand):
    ...
    python3 manage.py create_fake_data [number_of_records] (optional)

    Examples:
        python3 manage.py create_fake_data 20
        python3 manage.py create_fake_data --users 15

    Albunmanía-specific factories (Album, Sticker, Match, Trade, etc.) will be
    plugged here as their epics land in Bloque B.
    """
