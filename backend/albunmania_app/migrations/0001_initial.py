    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='albunmania_app.product')),
            ],
        ),
        migrations.CreateModel(
            name='Sale',
            fields=[
                ...
                ('sold_products', models.ManyToManyField(to='albunmania_app.soldproduct')),
            ],
        ),
    ]
