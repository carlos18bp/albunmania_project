...
from albunmania_app.serializers.blog_create_update import BlogCreateUpdateSerializer
from albunmania_app.serializers.blog_detail import BlogDetailSerializer
from albunmania_app.serializers.blog_list import BlogListSerializer
