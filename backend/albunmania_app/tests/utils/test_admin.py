...
from albunmania_app.admin import (
...
from albunmania_app.models import Blog, PasswordCode, Product, Sale, SoldProduct, User
...
def test_user_admin_login_as_link_renders_admin_url():
    ...
    assert f'/admin/albunmania_app/user/{user.id}/login_as/' in html
