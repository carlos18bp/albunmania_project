...
def test_url_modules_import_and_have_patterns():
    ...
    package_urls = importlib.import_module('albunmania_app.urls')
    assert hasattr(package_urls, 'urlpatterns')

    auth_urls = importlib.import_module('albunmania_app.urls.auth')
    blog_urls = importlib.import_module('albunmania_app.urls.blog')
    product_urls = importlib.import_module('albunmania_app.urls.product')
    sale_urls = importlib.import_module('albunmania_app.urls.sale')
    user_urls = importlib.import_module('albunmania_app.urls.user')
...
def test_module_urls_py_is_executable():
    ...
    spec = importlib.util.spec_from_file_location('albunmania_app.urls_module', urls_path)
