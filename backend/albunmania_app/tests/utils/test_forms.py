...
from albunmania_app.forms.blog import BlogForm
from albunmania_app.forms.product import ProductForm
from albunmania_app.forms.user import UserChangeForm, UserCreationForm
from albunmania_app.models import Blog, Product, User
